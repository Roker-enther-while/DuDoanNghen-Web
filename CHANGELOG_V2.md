...
- **Dataset**: Synthetic workload data (generated by SyntheticDataGenerator) emulating Google Cluster, Alibaba, Bitbrains, and Azure patterns (~470,000 samples). Real traces from Zenodo (Alibaba, Google 2019, Azure v2) downloaded separately to Data/real/.
