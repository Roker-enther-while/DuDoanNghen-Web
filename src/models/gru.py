"""Small Keras GRU model for smoke training."""
...
def build_model(input_shape, config: dict | None = None):
    ...
    try:
        ...
        raise ImportError("TensorFlow is required to build the GRU model") from exc
    ...
    model = tf.keras.Model(inputs, outputs, name="gru_smoke")
